...
## Acknowledgement
We refer to the code of [TComplEx](https://github.com/facebookresearch/tkbc) and [FTComplEx]([https://github.com/facebookresearch/tkbc](https://github.com/trungnnhcmue/FTPComplEx)). Thanks for their contributions.
